...
import com.ATM.service.java.com.ATM.exceptions.AccountBlockException;
import com.ATM.service.java.com.ATM.exceptions.InputErrorException;
import com.ATM.service.java.com.ATM.exceptions.NoSuchCardException;
import com.ATM.service.java.com.ATM.exceptions.NoSuchClientException;
...
public class LoginServiceImpl extends BaseService {
    ...
    public void execute() throws InputErrorException, NoSuchClientException, NoSuchCardException, AccountBlockException, IOException {
        String cardNumber = getStringFromConsole("Пожалуйста, введите номер карты в формате xxxx-xxxx-xxxx-xxxx", CARD_PATTERN);
        ...
        int attempts = 3;
        while (attempts != 0) {
            int pinCode = getIntFromConsole("Пожалуйста введите PIN код карты в формате xxxx");
            ...
            attempts--;
            LOGGER.error("Не верный PIN код. Осталось попыток: " + attempts);
        }
